(define
  ...
  (:init
    ...
    (body-pose table (0.7, 0, 0.0, 0, 0, 0))
    ...
    (body-pose green-mat::box (0.7, -0.3, 0.73, 0, 0, 0))
    (body-pose red-mat::box (0.75, 0.0, 0.73, 0, 0, 0))
    ...
    (body-pose shpam1 (0.45, 0.0, 0.76, 0, 0, 0.5))
    (body-pose shpam2 (0.45,  0.25, 0.76, 0, 0, -0.5))
    (body-pose shpam3 (0.45, -0.25, 0.76, 0, 0, 0))
