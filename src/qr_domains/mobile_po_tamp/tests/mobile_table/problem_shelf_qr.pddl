(define
  ...
  (:init
    ...
    (weld world::world table (0.85, 0, 0, 0, 0, 0))
    ...
    (weld world::world shelf-top (0.8, 0.0, 1.0, 0, 0, 0))
    ...
    (weld world::world shelf-left (0.8, -0.2, 0.85, 0, 0, 0))
    ...
    (weld world::world shelf-right (0.8, 0.2, 0.85, 0, 0, 0))
