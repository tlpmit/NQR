(define
  ...
  (:init
    ...
    ; (body-pose spam (1.03284035, 0.02635271, 0.79, 0., 1.5714, -0.7853982393431673))
    (body-pose spam1 (1.0, -0.1, 0.78, 0., 1.5714, -0.7853982393431673))
    (body-pose spam2 (1.0, 0.0, 0.78, 0., 1.5714, -0.7853982393431673))    
  ...
  (:goal (and (on spam1 pillar) (on spam2 spam1) ))
)