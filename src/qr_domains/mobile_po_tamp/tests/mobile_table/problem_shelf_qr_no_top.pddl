(define
  ...
  (:init
    ...
    (weld world::world table (0.7, 0, 0, 0, 0, 0))
    ...
    (body-pose grail (0.45, 0.0, 0.815, 0, 0, 0))
    ...
    ;(weld world::world shelf-top (0.85, 0.0, 1.0, 0, 0, 0))
    ...
    (weld world::world shelf-left (0.65, -0.25, 0.85, 0, 0, 0))
    ...
    (weld world::world shelf-right (0.65, 0.25, 0.85, 0, 0, 0))
