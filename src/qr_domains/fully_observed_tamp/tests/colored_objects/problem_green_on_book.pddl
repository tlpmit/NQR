(define
  ...
  (:init
    ...
    (body-pose shpam1 (0.9, 0.0, 0.76, 0, 0, 0))
    (body-pose shpam2 (0.9,  0.15, 0.76, 0, 0, 0))

    ; (qrgeom::box-shape book (0.2, 0.2, 0.025))
    ; (body-pose book (0.9, -0.2, 0.75, 0, 0, 0))
    (qrgeom::box-shape book (0.1, 0.05, 0.05))
    (body-pose book (0.9,  -0.15, 0.76, 0, 0, 0))
    (qrgeom::box-color book (1, 0, 1, 1.0))      

    (qrgeom::box-inertia shpam1 (4e-5, 4e-5, 4e-5))  
    (qrgeom::box-inertia shpam2 (4e-5, 4e-5, 4e-5))  
    (qrgeom::box-inertia book (4e-5, 4e-5, 4e-5))  

    (qrgeom::box-mass shpam1 0.01)  
    (qrgeom::box-mass shpam2 0.01)  
    (qrgeom::box-mass book 0.02)  
