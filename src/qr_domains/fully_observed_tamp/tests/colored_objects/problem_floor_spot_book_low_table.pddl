(define
  ...
  (:init
    ...
    ; table
    (qrgeom::box-shape table (1.0, 2.0, 0.1))
    (body-pose table (1.2, 0.0, 0.05, 0.0, 0.0, 0.0))
    ...
    (body-pose shpam1 (0.9, 0.0, 0.13, 0, 0, 0))
    (body-pose shpam2 (0.9,  0.15, 0.13, 0, 0, 0))

    (qrgeom::box-shape book (0.4, 0.4, 0.025))
    (body-pose book (1.0, -0.3, 0.1125, 0, 0, 0))
